...
var RecyclerListView = /** @class */ (function (_super) {
    ...
    function RecyclerListView(props, context) {
        ...
        _this._onSizeChanged = function (layout) {
            ...
            if (_this.props.onSizeChange) {
                _this.props.onSizeChange(_this.getRenderedSize(), _this.getContentDimension());
            }
        };
    ...
    RecyclerListView.prototype._checkAndChangeLayouts = function (newProps, forceFullRender) {
        var _a = this.getContentDimension(), oldContentHeight = _a.height, oldContentWidth = _a.width;
        ...
        var _b = this.getContentDimension(), newContentHeight = _b.height, newContentWidth = _b.width;
