...
var StickyContainer = /** @class */ (function (_super) {
    ...
    function StickyContainer(props, context) {
        ...
        _this._rlvRowRenderer = function (type, data, index, extendedState) {
            if (_this.props.alwaysStickyFooter) {
                if (!_this._isRlvScrollable && _this.props.stickyFooterIndices
                    && index === _this.props.stickyFooterIndices[_this.props.stickyFooterIndices.length - 1]) {
                    return null;
                }
            }
            return _this._rowRenderer(type, data, index, extendedState);
        };
        _this._onSizeChange = function (rlvDimension, contentDimension) {
            var isScrollable = _this._isRlvScrollable;
            ...
            if (_this._recyclerRef && _this._isRlvScrollable !== isScrollable) {
                _this._isRlvScrollable = isScrollable;
                if (!isScrollable && _this._stickyFooterRef) {
                    _this._stickyFooterRef.onScroll(0);
                    _this.forceUpdate();
                }
                _this._recyclerRef.forceRerender();
            }
        };
    ...
    StickyContainer.prototype.renderCompat = function () {
        ...
        var recycler = React.cloneElement(this.props.children, __assign({}, this.props.children.props, { ref: this._getRecyclerRef, onVisibleIndicesChanged: this._onVisibleIndicesChanged, onScroll: this._onScroll, applyWindowCorrection: this._applyWindowCorrection, rowRenderer: this._rlvRowRenderer, onSizeChange: this.props.alwaysStickyFooter ? this._onSizeChange : undefined }));
